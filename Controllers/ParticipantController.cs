...
{[Authorize]
    public class ParticipantController : Controller
    {
        ...
        public ParticipantController(QOTDContext context)
        {
            _context = context;
        }
        ...
        {
            return View(await _context.ParticipantQOTD.ToListAsync());
        }
        ...
        private bool ParticipantQOTDExists(int id)
        {
            return _context.ParticipantQOTD.Any(e => e.ID == id);
        }
    }
}
